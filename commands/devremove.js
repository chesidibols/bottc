...
module.exports.run = async (bot, message, args) =>{
    ...
    Data.findOne({
        ...
        console.log(logsCoin).send({embed:{color:'a20a28', description:`**${message.author.username}** removed ${args[1]}<:coinns:699944502856646716> to **${bot.users.cache.get(user.id).tag}**`}});
