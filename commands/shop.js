...
module.exports.run = async (bot, message, args) =>{
    ...
    let embed = new Discord.MessageEmbed();
        ...
        embed.addFields(
            ...
            { name: `**13# 10,000 coins**`, value: `<@&${daiquiri}>`, inline: true },
            { name: `**14# 10,000 coins**`, value: `<@&${blue_hawaii}>`, inline: true },
            { name: `**15# 10,000 coins**`, value: `<@&${mojito}>`, inline: true },
            { name: `**16# 10,000 coins**`, value: `<@&${blue_lagoon}>`, inline: true },
            { name: `**17# 10,000 coins**`, value: `<@&${miami_bice}>`, inline: true },
            { name: `**18# 10,000 coins**`, value: `<@&${hurricane}>`, inline: true },
            { name: `**19# 10,000 coins**`, value: `<@&${purple_bage}>`, inline: true },
        )
